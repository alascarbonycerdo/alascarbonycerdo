  ...
  <div class="min-h-screen bg-ink pb-16">
    <div class="mx-auto max-w-2xl px-5 pt-8">
      <header class="flex items-center justify-between">
        <div>
          <p class="font-display text-2xl text-gold">Costeo de productos</p>
          <p class="text-xs uppercase tracking-widest text-ember-soft">Alas Carbón &amp; Cerdo</p>
        </div>
        <NuxtLink to="/dashboard" class="text-xs font-medium text-gold-soft/70 underline-offset-4 hover:text-gold hover:underline">
          Volver al dashboard
        </NuxtLink>
      </header>
